...
async function stopAndRemoveContainer(containerName) {
    ...
    try {
        ...
        const errMsg = error.stderr?.toLowerCase() || error.message?.toLowerCase() || '';
...
const concurrentlyArgs = [
    ...
    '--names', 'API,UI,WHISPER', // Names for prefixing output lines
    '--prefix-colors', 'bgBlue.bold,bgMagenta.bold,bgCyan.bold', // Colors for prefixes
