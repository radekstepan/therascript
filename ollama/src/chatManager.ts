...
export function startNewChat(
    ...
    } else if (initialMessages && systemPrompt && !initialMessages.some(m => m.role === 'system')) {
    ...
    console.log(`✨ Started/Initialized in-memory chat (ID: ${chatId}) with model: ${model}`);
    return chatId;
}
 ...
 */
export function listActiveChats(): { id: string; model: string; createdAt: string; messageCount: number }[] {
