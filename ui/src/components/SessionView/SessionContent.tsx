    ...
    return (
        ...
        <Flex flexGrow="1" style={{ minHeight: 0, overflow: 'hidden' }}>
            ...
            >
                ...
                <Flex direction="column" className="lg:w-1/2" style={{ minHeight: 0, height: '100%' }}> {/* Ensure height for ChatInterface */}
                    {activeChatId !== null ? (
                ...
                <Flex direction="column" className="lg:w-1/2" style={{ minHeight: 0, height: '100%' }}> {/* Ensure height for Transcription */}
                    <Transcription
                        session={session}
