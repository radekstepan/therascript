            ...
            <div className="flex-grow flex flex-col min-h-0 relative">
                {isEditingOverall ? (
                    ...
                    <Textarea
                        ...
                        className="flex-grow w-full whitespace-pre-wrap text-sm font-mono leading-relaxed p-3 h-full resize-none border-gray-200 dark:border-gray-700 rounded-md bg-white dark:bg-gray-900" // Style directly or use Input component style
                    ...
                    <div className="flex-grow overflow-y-auto border border-gray-200 dark:border-gray-700 rounded-md p-1 bg-white dark:bg-gray-900">
                            ...
                            {paragraphs.length > 0 ? paragraphs.map((paragraph, index) => (
                                <div key={index} className="relative group">
                                    {editingParagraphIndex === index ? (
                                        ...
                                        <div className="p-1 rounded-md hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors duration-150">
                                            ...
                                            <Button
                                                ...
                                                className="absolute top-1 right-1 h-6 w-6 p-0 opacity-0 group-hover:opacity-100 focus-visible:opacity-100 transition-opacity text-gray-400 hover:text-blue-600 dark:text-gray-500 dark:hover:text-blue-500"
