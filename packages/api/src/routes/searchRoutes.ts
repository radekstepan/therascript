    ...
    .group('', { detail: { tags: ['Search'] } }, (app) => app
        .get('/', async ({ query, set }) => {
            ...
            detail: {
                ...
                description: 'Performs a full-text search across message and transcript content. Returns relevant messages and paragraphs including associated client name and tags (if applicable).', // Updated description
            }
        })
    );
