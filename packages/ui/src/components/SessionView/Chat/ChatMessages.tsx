        ...
        <>
            <Flex direction="column" gap="3">
                {messages.map((message) => {
                    ...
                    const showSpinner = isStreamingThisMessage && message.text === '' && isAiResponding;
                    ...
                    const showCopyButton = message.sender === 'ai' && !isStreamingThisMessage; // Show copy only for completed AI messages
                        ...
                        >
                            ...
                            >
                                ...
                                {showSpinner ? (
                                    ...
                                    {message.sender === 'ai' && renderMd ? (
                                        ...
                                        <Text size="2" style={{ whiteSpace: 'pre-wrap', wordBreak: 'break-word' }}>
                                            {message.text || (isStreamingThisMessage ? '' : '...')} {/* Show empty if streaming and no text yet */}
                                            {showBlinkingCursor && (
                                                <span className="streaming-cursor" style={{ animationPlayState: 'running' }}></span>
                                            )}
                                        </Text>
                                ...
                                {message.starred && message.starredName && (
                                    <Flex align="center" gap="1" mt="1" justify={message.sender === 'user' ? 'end' : 'start'}>
                 ...
                 {isAiResponding && !streamingMessageId && !messages.some(m => m.id === streamingMessageId) && (
